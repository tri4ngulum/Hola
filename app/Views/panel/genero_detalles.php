...
if (empty($id_genero)) {
  echo '<script>
                alert("Error, el género no se encontro");
  ...
  $query_select = 'SELECT * FROM generos WHERE id_genero = ' . $id_genero;

  $query_res = mysqli_query($conexion, $query_select);
  $genero = mysqli_fetch_array($query_res, MYSQLI_ASSOC);

  if (sizeof($genero) <= 0) {
    echo '<script>
                alert("Error, el género que deseas actualizar no esxiste");
                window.location = "./generos.php";
                </script>';
  }
...
<head>
  ...
  <title>AdminLTE 3 | Detalles género</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Género Detalles</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                <li class="breadcrumb-item"><a href="#">Géneros</a></li>
                <li class="breadcrumb-item active">Detalles género</li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-primary">
                ...
                <form id="form-genero" action="../backend/crud/generos/update_genero.php" method="post">
                  <div class="card-body">
  ...
  <script src="../js/genero_detalles.js"></script>
</body>
