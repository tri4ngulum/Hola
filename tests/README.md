...
The repository has a ``phpunit.xml.RECURSOS`` file in the project root that's used for
PHPUnit configuration. This is used to provide a default configuration if you
do not have your own configuration file in the project root.

The normal practice would be to copy ``phpunit.xml.RECURSOS`` to ``phpunit.xml``
...
you will need to rename **phpunit.xml.RECURSOS** to **phpunit.xml**, uncomment the database
